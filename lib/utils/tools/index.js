...
var import_js_bridge = require("../../plugins/js-bridge");
var import_html_utils = require("../html-utils");
...
const goProtocol = (key) => {
  if (import_js_bridge.jsBridge.isYouxinApp) {
    import_js_bridge.jsBridge.gotoNewWebview(
...
const downloadFile = (url, filename = "") => {
  if (import_html_utils.isIOS) {
    if (import_html_utils.isYouxinApp) {
      import_js_bridge.jsBridge.gotoNewWebview(url);
      return;
    }
